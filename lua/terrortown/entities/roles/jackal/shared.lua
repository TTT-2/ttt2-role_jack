...
Make use of your sidekick deagle to shoot yourself a partner in crime.]])
		...
		LANG.AddToLanguage("Italiano", self.name, "Sciacallo")
		LANG.AddToLanguage("Italiano", self.defaultTeam, "TEAM Sciacallo")
		LANG.AddToLanguage("Italiano", "info_popup_" .. self.name, [[Sei lo Sciacallo! Prova ad uccidere tutti tranne te!
Usa la tua deagle spalla per colpire qualcuno e farlo diventare la tua spalla.]])
		LANG.AddToLanguage("Italiano", "body_found_" .. self.abbr, "Era uno Sciacallo!")
		LANG.AddToLanguage("Italiano", "search_role_" .. self.abbr, "Questa persona era uno Sciacallo!")
		LANG.AddToLanguage("Italiano", "target_" .. self.name, "Sciacallo")
		LANG.AddToLanguage("Italiano", "ttt2_desc_" .. self.name, [[Lo Sciacallo deve vincere da solo o con la sua spalla!]])
		LANG.AddToLanguage("Italiano", "hilite_win_" .. self.defaultTeam, "GLI SCIACALLI HANNO VINTO")
		LANG.AddToLanguage("Italiano", "win_" .. self.defaultTeam, "Gli Sciacalli hanno vinto!")
		LANG.AddToLanguage("Italiano", "ev_win_" .. self.defaultTeam, "Il malvagio Sciacallo ha vinto il round!")
		LANG.AddToLanguage("Italiano", "credit_" .. self.abbr .. "_all", "Sciacalli, vi sono stati dati {num} credito/i per la vostra performance.")
