...
Make use of your sidekick deagle to shoot yourself a partner in crime.]])
		...
		LANG.AddToLanguage("Italiano", self.name, "Jackal")
		LANG.AddToLanguage("Italiano", self.defaultTeam, "TEAM Jackal")
		LANG.AddToLanguage("Italiano", "info_popup_" .. self.name, [[Sei il Jackal! Prova ad uccidere tutti tranne te!
Usa la tua Sidekick Deagle per colpire qualcuno e farlo diventare il tuo Sidekick.]])
		LANG.AddToLanguage("Italiano", "body_found_" .. self.abbr, "Era un Jackal!")
		LANG.AddToLanguage("Italiano", "search_role_" .. self.abbr, "Questa persona era un Jackal!")
		LANG.AddToLanguage("Italiano", "target_" .. self.name, "Jackal")
		LANG.AddToLanguage("Italiano", "ttt2_desc_" .. self.name, [[Il Jackal deve vincere da solo o con il suo Sidekick!]])
		LANG.AddToLanguage("Italiano", "hilite_win_" .. self.defaultTeam, "I JACKAL HANNO VINTO")
		LANG.AddToLanguage("Italiano", "win_" .. self.defaultTeam, "I Jackal hanno vinto!")
		LANG.AddToLanguage("Italiano", "ev_win_" .. self.defaultTeam, "Il malvagio Jackal ha vinto il round!")
		LANG.AddToLanguage("Italiano", "credit_" .. self.abbr .. "_all", "Jackal, vi sono stati dati {num} credito/i per la vostra performance.")
